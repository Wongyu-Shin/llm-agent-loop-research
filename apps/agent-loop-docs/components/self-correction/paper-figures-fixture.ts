...
export const FAN_CASES: FanCase[] = [
  {
    ...
    alphaProvenance: "derived",
    trajectories: [
      { label: "Acc₀ 0%", empiricalPercentByRound: [0, 45, 65, 72, 75, 76.5] },
      { label: "Acc₀ 20%", empiricalPercentByRound: [20, 55, 70, 74, 76, 77] },
      { label: "Acc₀ 40%", empiricalPercentByRound: [40, 63, 72, 75, 76.5, 77] },
      { label: "Acc₀ 60%", empiricalPercentByRound: [60, 70, 74, 76, 77, 77.2] },
      { label: "Acc₀ 80%", empiricalPercentByRound: [80, 78.5, 78, 77.7, 77.5, 77.4] },
      { label: "Acc₀ 100%", empiricalPercentByRound: [100, 90, 83, 80, 78.5, 78] },
    ],
  ...
  },
  {
    ...
    alphaProvenance: "derived",
    trajectories: [
      { label: "Acc₀ 0%", empiricalPercentByRound: [0, 50, 60, 63, 64, 64.8] },
      { label: "Acc₀ 20%", empiricalPercentByRound: [20, 55, 62, 64, 64.5, 65] },
      { label: "Acc₀ 40%", empiricalPercentByRound: [40, 60, 63.5, 64.5, 65, 65] },
      { label: "Acc₀ 60%", empiricalPercentByRound: [60, 64, 64.8, 65, 65, 65] },
      { label: "Acc₀ 80%", empiricalPercentByRound: [80, 70, 67, 66, 65.5, 65.2] },
      { label: "Acc₀ 100%", empiricalPercentByRound: [100, 80, 71, 68, 66.5, 65.8] },
    ],
  ...
  },
  {
    ...
    alphaProvenance: "derived",
    trajectories: [
      { label: "Acc₀ 0%", empiricalPercentByRound: [0, 60, 75, 80, 82.5, 83.5] },
      { label: "Acc₀ 20%", empiricalPercentByRound: [20, 65, 78, 81.5, 83, 84] },
      { label: "Acc₀ 40%", empiricalPercentByRound: [40, 72, 80, 82.5, 83.5, 84] },
      { label: "Acc₀ 60%", empiricalPercentByRound: [60, 78, 82, 83.5, 84, 84.3] },
      { label: "Acc₀ 80%", empiricalPercentByRound: [80, 83, 84, 84.3, 84.4, 84.5] },
      { label: "Acc₀ 100%", empiricalPercentByRound: [100, 92, 88, 86, 85.3, 85] },
    ],
    note: "초기 정답을 인위 배정한 실험",
  },
];
