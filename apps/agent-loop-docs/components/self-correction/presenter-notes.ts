...
const notes = {
  "scene-01": [
    ...
    { id: "S01.04", text: "그러나 실제 agent 의 loop 의 iteration 간에는 틀린 답이 맞아지는 동시에 맞던 답이 틀어질 수 있습니다." },
  ...
  "scene-02": [
    { id: "S02.01", text: "논문의 가정하는 상황은, 외부 피드백 없이 자신의 이전 답을 다시 검토하는 상황입니다. 원문에서는 intrinsic self-correction이라고 부르더군요." },
    ...
    { id: "S02.14", text: "현재 정답 집단에서 다음 라운드까지 보존되는 질량은 라운드 t 의 정확도에 보존 확률을 곱한 값입니다." },
    { id: "S02.15", text: "현재 정답 집단에서 훼손되어 빠져나가는 질량은 라운드 t 의 정확도에 1 에서 보존 확률을 뺀 값을 곱한 값입니다." },
    ...
    { id: "S02.18", text: "따라서 다음 정확도는 라운드 t 의 정확도에 정답이 남을 확률과, 훼손된 정답이 복구될 확률을 더한뒤 곱한 값입니다." },
  ...
  "scene-03": [
    ...
    { id: "S03.06", text: "높은 정확도를 목표할수록 조건은 가혹해져서, 높은 목적지의 조합은 모서리 근처의 좁은 띠에 몰립니다." },
